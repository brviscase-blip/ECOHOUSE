            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-400">Av. Paulista, 1000 - Jardins<br />São Paulo - SP, 01310-100</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-400">+55 (11) 3333-4444</p>
                  <p className="text-gray-400">+55 (11) 99999-8888 (WhatsApp)</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium text-white">E-mail</h4>
                  <p className="mt-1 text-gray-400">contato@ecohouse.com.br</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium text-white">Horário</h4>
                  <p className="mt-1 text-gray-400">Segunda a Sexta: 08h às 18h</p>
                </div>
              </div>
            </div>
          </div>
