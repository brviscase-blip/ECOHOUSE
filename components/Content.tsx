...
const Content: React.FC = () => {
  ...
  return (
    <section id="content" className="py-40 bg-[#16827d] text-white relative overflow-hidden transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
          {(activeTab === 'house' ? ecoHouseContent : ecoProContent).map((item, idx) => (
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-[#16827d]/10 text-emerald-400 mb-10 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-500 shadow-inner">
                {item.icon}
              </div>
